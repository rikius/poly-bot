...
impl Ledger {
    ...
    ///
    /// Called at startup after reading the Polymarket CLOB `balance-allowance`
    /// endpoint so the ledger reflects the wallet's actual deposited USDC.
    pub fn sync_cash(&self, on_chain_balance: rust_decimal::Decimal) {
